...
# Trust scoring — Validation (exit 10)
ERR_VALIDATION_TRUST_PROFILE = "ERR_VALIDATION_TRUST_PROFILE"
ERR_VALIDATION_TRUST_DOC_CLASS = "ERR_VALIDATION_TRUST_DOC_CLASS"
ERR_VALIDATION_TRUST_RESOURCE = "ERR_VALIDATION_TRUST_RESOURCE"
ERR_VALIDATION_TRUST_PROPERTY_SIZE = "ERR_VALIDATION_TRUST_PROPERTY_SIZE"
ERR_VALIDATION_TRUST_SCORE = "ERR_VALIDATION_TRUST_SCORE"
ERR_VALIDATION_SKILL_DESCRIPTION = "ERR_VALIDATION_SKILL_DESCRIPTION"

# Trust scoring — I/O (exit 50)
ERR_IO_TRUST_METADATA = "ERR_IO_TRUST_METADATA"
ERR_IO_TRUST_TIMEOUT = "ERR_IO_TRUST_TIMEOUT"
ERR_IO_TRUST_CAPABILITY = "ERR_IO_TRUST_CAPABILITY"

# Trust scoring — Conflict (exit 40)
ERR_CONFLICT_TRUST_WRITEBACK = "ERR_CONFLICT_TRUST_WRITEBACK"

# Trust scoring — Internal (exit 90)
ERR_INTERNAL_TRUST_CACHE = "ERR_INTERNAL_TRUST_CACHE"
